...
type DappState = any & { selectedAddress: any } & { tokenData: { name: any, symbol: any } } & {
  balance: any
} & { txBeingSent: any } & { transactionError: any } & { txBeingSent: undefined } & {
  transactionError: undefined
} & { networkError: undefined } & any & { networkError: string } & any;
        ...
        <div className="row">
          <div className="col-12">
            ...
            {this.state.balance.gt(0) && (
              <Transfer
                transferTokens={(to: any, amount: any) => this._transferTokens(to, amount)}
